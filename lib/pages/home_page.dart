...
import 'package:chatappnew2021/pages/Chating.dart';
                ...
                children: [
                  ...
                  Expanded(
                      ...
                      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                        if (snapshot.hasData) {
                          if ((snapshot.data?.docs.length ?? 0) > 0) {
                            ...
                            return Center(
                              child: Text("Lets start Chat with friends!"),
                            );
                          }
                        } else {
                          return Center(
                   ...
                   Center(child: Padding(
                     padding: EdgeInsets.only(bottom: 222),
                     child: Text("Lets start Chat with friends!",style: TextStyle(fontWeight: FontWeight.w300,fontSize: 16),),
                   )),
                ],
              ),
